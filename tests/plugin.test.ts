...
describe("rtl-css-transform-webpack-plugin", () => {
    it("Should transform LTR to RTL", async () => {
        ...
        expect(bundle.readFileSync(resolver("main.rtl.css")).toString('utf8')).toEqual(
            fs.readFileSync(resolver("cases", "simple", "expected.css")).toString('utf8')
        );
    });
    ...
    it("Should change file name", async () => {
        ...
        expect(bundle.readFileSync(resolver("rtl", "0.css")).toString('utf8')).toEqual(
            fs.readFileSync(resolver("cases", "filename", "expected.css")).toString('utf8')
        );
    });
    ...
    it("Should generate source mapping", async () => {
        ...
        expect(bundle.readFileSync(resolver("main.rtl.css")).toString('utf8')).toEqual(
            fs.readFileSync(resolver("cases", "sourcemap", "expected.css")).toString('utf8')
        );
    });
    ...
    it("Should minimize bundle", async () => {
        ...
        expect(bundle.readFileSync(resolver("main.rtl.css")).toString('utf8')).toEqual(
            fs.readFileSync(resolver("cases", "minimize", "expected.css")).toString('utf8')
        );
    });
    ...
    it("Should take into account RTLCSS options", async () => {
        ...
        expect(bundle.readFileSync(resolver("main.rtl.css")).toString('utf8')).toEqual(
            fs.readFileSync(resolver("cases", "options", "expected.css")).toString('utf8')
        );
    });
    ...
    it("Should take into account RTLCSS plugins", async () => {
        ...
        expect(bundle.readFileSync(resolver("main.rtl.css")).toString('utf8')).toEqual(
            fs.readFileSync(resolver("cases", "plugins", "expected.css")).toString('utf8')
        );
    });
    ...
    it("Should take into account RTLCSS hooks", async () => {
        ...
        expect(bundle.readFileSync(resolver("main.rtl.css")).toString('utf8')).toEqual(
            fs.readFileSync(resolver("cases", "hooks", "expected.css")).toString('utf8')
        );
    });
});
